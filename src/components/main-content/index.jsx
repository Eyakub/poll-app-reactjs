  ...
  render(){
    if (Object.keys(this.props.poll).length === 0){
      return (
        <div>
          ...
          <p>
            You can create as many poll as you want. Click the new butotn to createa new poll.
          </p>
        </div>
      )
    }
    ...
    return (
      <div>
        ...
        <Modal isOpenk={this.state.openModal} toggle={this.toggleModal} unmountOnClose={true}>
